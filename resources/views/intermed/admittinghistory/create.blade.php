			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-4">
		               ...
		               <label class="control-label">Musculskeletal</label>
		               <div class="checkbox">
	                        <label class="form-check-label">
					...
					<div class="col-sm-4">
		               ...
		               <div class="checkbox">
						...
						<label class="control-label">Endocrine</label>
						<div class="checkbox">
	                        <label class="form-check-label">
				...
				<div class="row">
					<div class="col-sm-4">
						<label class="control-label">Genitourinary</label>
						<div class="checkbox">
	                        <label class="form-check-label">
					...
					<div class="col-sm-4">
						<label class="control-label">Gastroenterology</label>
						<div class="checkbox">
	                        <label class="form-check-label">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="row blockquote" style="margin-top:20px;">
					<div class="col-sm-4">
						<label class="control-label">Skin/Extremities</label>
						<div class="checkbox">
	                        <label class="form-check-label">
					...
					<div class="col-sm-5">
						<label class="control-label">Other Pertinent Findings</label>
				...
				<div class="row blockquote">
					<div class="col-sm-4">
						<label class="control-label">Chest and Lungs</label>
						<div class="checkbox">
	                        <label class="form-check-label">
				...
				<div class="row blockquote">
					<div class="col-sm-4">
						<label class="control-label">Abdomen and Rectal</label>
						<div class="checkbox">
	                        <label class="form-check-label">
				...
				<div class="row blockquote">
					<div class="col-sm-7">
						<label class="control-label">GU(IE)</label>
						<div class="checkbox">
	                        <label class="form-check-label">
				...
				<div class="row blockquote">
					<div class="col-sm-7">
						<label class="control-label">Extremities</label>
						<div class="checkbox">
	                        <label class="form-check-label">
...
<div class="col-md-12 grid-margin ">
	<div class="box box-info">
		<div class="box-body">		
			...
			<div class="row" >
				<div class="col-sm-4">
					<label class="control-label">Cerebral</label>
					<div class="checkbox">
						<label class="form-check-label">
...
<div class="col-md-12 grid-margin">
    ...
    <input type="hidden" value="{{Auth::user()->uname}}" name="EncodedBy" >
    <input type="hidden" value="{{$patient->Healthnum}}" name="Healthno" >
